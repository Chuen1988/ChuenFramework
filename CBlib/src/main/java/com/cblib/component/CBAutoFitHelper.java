 ...
 */
public class CBAutoFitHelper {

    private static final String TAG = "AutoFitTextHelper";
    private static final boolean SPEW = false;

    // Minimum size of the text in pixels (sdp)
    private static final int DEFAULT_MIN_TEXT_SIZE = 12;
    // How precise we want to be when reaching the target textWidth size
    private static final float DEFAULT_PRECISION = 0.5f;

    /**
     * Creates a new instance of {@code GreatCBAutoFitHelper} that wraps a {@link TextView} and enables
     * automatically sizing the text to fit.
     */
    public static CBAutoFitHelper create(TextView view) {
     ...
     * automatically sizing the text to fit.
     */
    public static CBAutoFitHelper create(TextView view, AttributeSet attrs) {
     ...
     * automatically sizing the text to fit.
     */
    public static CBAutoFitHelper create(TextView view, AttributeSet attrs, int defStyle) {
        CBAutoFitHelper helper = new CBAutoFitHelper(view);
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(
                    ...
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(R.styleable.CB_textSizeToFit, false);
            minTextSize = ta.getDimensionPixelSize(R.styleable.CB_minTextSize,
                    minTextSize);
            precision = ta.getFloat(R.styleable.CB_textPrecision, precision);
            ta.recycle();
    ...
    private CBAutoFitHelper(TextView view) {
        ...
        mMinTextSize = (int) (DEFAULT_MIN_TEXT_SIZE / scaledDensity);
     ...
     */
    public CBAutoFitHelper addOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners == null) {
     ...
     */
    public CBAutoFitHelper removeOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners != null) {
     ...
     */
    public CBAutoFitHelper setPrecision(float precision) {
     ...
     */
    public CBAutoFitHelper setMinTextSize(float size) {
     ...
     * @attr ref me.grantland.R.styleable#AutofitTextView_minTextSize
     */
    public CBAutoFitHelper setMinTextSize(int unit, float size) {
     ...
     */
    public CBAutoFitHelper setMaxTextSize(float size) {
     ...
     * @attr ref android.R.styleable#TextView_textSize
     */
    public CBAutoFitHelper setMaxTextSize(int unit, float size) {
        Context context = mTextView.getContext();
        Resources r = Resources.getSystem();
     ...
     */
    public CBAutoFitHelper setMaxLines(int lines) {
        if (mMaxLines != lines) {
            mMaxLines = lines;
     ...
     */
    public CBAutoFitHelper setEnabled(boolean enabled) {
        if (mEnabled != enabled) {
            mEnabled = enabled;
    ...
    /**
     * When an object of a type is attached to an {@code GreatCBAutoFitHelper}, its methods will be called
